...
from obsidian_rag.v3_8.schemas import ContextBundle, ContextChunk, EvidenceCheckResult, MemorySnapshot, StepResult
...
def build_memory_aware_planner_question(question: str, memory_snapshot: MemorySnapshot) -> str:
    if not memory_snapshot.recent_turns:
        return question
...
请结合最近对话理解当前问题中的指代，但只规划当前问题需要执行的步骤。"""
