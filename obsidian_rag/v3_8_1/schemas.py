...
class AgentAskRequest(BaseModel):
    ...
    memory_compaction_trigger_turns: int = Field(default=4, ge=1, le=100)
    memory_compaction_trigger_tokens: int = Field(default=3000, ge=100, le=50000)
...
class MemorySnapshot(BaseModel):
    ...
    summary_text: str = ""
    summary_through_turn_id: str | None = None
...
class MemoryCompactRequest(BaseModel):
    keep_recent_turns: int = Field(default=3, ge=0, le=20)
    trigger_turns: int = Field(default=4, ge=1, le=100)
    trigger_tokens: int = Field(default=3000, ge=100, le=50000)
    force: bool = True
